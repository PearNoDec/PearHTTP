...
items = {"UTF-8", "GBK", "GB2312", "GB18030", "Big5", "UTF-16", "UTF-16BE", "UTF-16LE", "US-ASCII", "ISO-8859-1", "CESU-8"}
...
spintwo.onItemSelected = function(parent, view, position, id)
  SelectModelTwo = items[position + 1]
end

StringEn.onClick=function()
  local ChooseText = InputText.Text
  local ResultEn = luajava.coding(ChooseText,SelectModelTwo,SelectModel)
