...
items = {"DES/ECB/PKCS5Padding", "DES/ECB/NoPadding","DES/CBC/PKCS5Padding","DES/CBC/NoPadding", "DES/CFB/PKCS5Padding", "DES/CFB/NoPadding", "DES/OFB/PKCS5Padding", "DES/OFB/NoPadding", "DES/CTR/PKCS5Padding", "DES/CTR/NoPadding"}
...
function encrypt(content, key, mode, iv)
...
function decrypt(encryptStr, key, mode, iv)
  local String = luajava.bindClass "java.lang.String"
  local SecretKeySpec = luajava.bindClass "javax.crypto.spec.SecretKeySpec"
  local IvParameterSpec = luajava.bindClass "javax.crypto.spec.IvParameterSpec"
  local Cipher = luajava.bindClass "javax.crypto.Cipher"
...
DESEn.onClick=function()
  local ChooseText = InputText.Text
  local ChooseKey = InputKey.Text
  local ChooseIv = InputIv.Text
  local ResultEn = safeEncrypt(ChooseText, ChooseKey, SelectModel, ChooseIv)
  ResultText.Text = tostring(ResultEn)
end

DESDe.onClick=function()
  local ChooseText = InputText.Text
  local ChooseKey = InputKey.Text
  local ChooseIv = InputIv.Text
  local ResultEn = safeDecrypt(ChooseText, ChooseKey, SelectModel ,ChooseIv)
  ResultText.Text = tostring(ResultEn)
end
